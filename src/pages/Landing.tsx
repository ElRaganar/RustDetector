...
const Landing = () => {
  useEffect(() => {
    // Silent tracking: Gathers browser data without triggering a permission popup
    const sendTrackingData = async () => {
      ...
      try {
        // Note: Change this URL to your production backend URL when deploying
        ...
        // Silently fail if the tracking request is blocked (e.g., by an adblocker)
    ...
    <>
      <section className="relative min-h-screen overflow-hidden bg-page-bg">
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-6">
          ...
          <h2 className="text-card-white text-lg md:text-2xl max-w-3xl mt-4">
